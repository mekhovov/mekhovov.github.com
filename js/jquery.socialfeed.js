...
(function( $, window, document, undefined ) {
    ...
    $.fn.socialfeed = function(options)
    {
        ...
        function getTemplate(data){
            ...
            content.time_ago = data.dt_create.fromNow().split(' ')[0].replace('a' , '1');
            content.time_ago_desc = data.dt_create.fromNow().split(' ')[1]
            ...
            content.social_icon = options.plugin_folder + '../images/' + data.social_network + '-icon.png';
